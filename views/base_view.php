    ...
    <body>
        ...
        <!-- début du navbar-->
            ...
            <nav class="navbar navbar-expand-lg bg-dark"  data-bs-theme="dark">
                ...
                <a class="navbar-brand"><img width="100px" src="/public/asset/logo.png"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <a class="nav-link active" aria-current="pages" href="/home">Acceuil</a>
                        ...
                        <a class="nav-link" href="/signin"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
...
<p> c'est la partie main </p>
        ...
        <footer class="bg-dark text-clear text-center footer">
            ...
            <div class="col-md-4">
                <h3 ><a href="/Pages/mentions_legals.html">Mentions légals</a></h3>
