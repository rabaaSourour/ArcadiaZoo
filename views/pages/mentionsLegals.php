<div class="container rounded mt-3">
    ...
    <p class="text-dark">Le site web www.zooarcadia.com et l'ensemble de son contenu, y compris les textes,
        images, vidéos, graphismes, logos, icônes, et autres éléments, sont la propriété exclusive de Zoo Arcadia, sauf mention contraire.
        Toute reproduction, distribution, modification, adaptation, retransmission ou publication de ces différents éléments est strictement interdite
        sans l'accord écrit préalable de Zoo Arcadia.
    </p>

    <h3 class="text-bg-secondary rounded m-3 p-2">Responsabilité :</h3>

    <p>Zoo Arcadia s'efforce de fournir des informations précises et mises à jour sur son site web.
        Toutefois, Zoo Arcadia ne saurait être tenu responsable des erreurs, omissions ou résultats obtenus suite à une mauvaise utilisation de ces informations.
        Zoo Arcadia ne peut être tenu responsable de l'interprétation des informations contenues dans ce site, ni des conséquences de leur utilisation.
    </p>

    <h3 class="text-bg-secondary rounded m-3 p-2">Données personnelles :</h3>

    <p class="text-dark">Conformément à la loi "Informatique et Libertés" du 6 janvier 1978 modifiée, et au Règlement Général sur la Protection des Données (RGPD),
