...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <li class="nav-item p-4">
                            ...
                            <a class="nav-link active" aria-current="pages" href="/views/pages/home.php">Acceuil</a>

                        </li>
                        <li class="nav-item p-4">

                            <a class="nav-link" href="/views/pages/habitat.php">Habitats</a>

                        </li>
                        <li class="nav-item p-4">

                            <a class="nav-link" href="/views/pages/contact.php">Contacts</a>

                        </li>
                        <li class="nav-item p-4">

                            <a class="nav-link" href="/views/pages/service.php">Services</a>

                        </li>

                        <li class="nav-item ms-auto p-2" data-show="disconnected">

                            <a class="nav-link" href="/views/pages/signin.php"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
    ...
    <footer class="bg-dark text-clear text-center footer">
        <div class="row">
            ...
            <div class="col-md-4">
                <h3><a href="/views/pages/Pages/mentionsLegals.php">Mentions légals</a></h3>
